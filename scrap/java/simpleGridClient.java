 ...
 */
public class simpleGridClient extends Thread {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(simpleGridClient.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public Socket connect(String host, int port) {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(simpleGridClient.class.getName()).log(Level.SEVERE, null, ex1);
            }
