...
//	Lat: 1.4866 Lon: -132.5493 Alt: 0 m
//	Lat: 1.5354 Lon: -132.5026 Alt: 0 m
	double lat_high = 1.5354;//53.496089786696714;// 53.492;
	double lat_low = 1.4866;//53.445192256636574;// 53.444;
	boolean limitsSetUsingKeepInZone = false;

	double lon_high = -132.5026;//-1.8348498429921174;// -1.8354;
	double lon_low = -132.5493;//-//1.7534335596466306;// -1.754;
	int numActions = 9;
	// lat = y
	// lon = x
	int numCellsSide = 20;
