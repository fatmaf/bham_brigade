...
*/
public class GimballedPayloadState extends PayloadState {
    ...
    public GimballedPayloadState(long PayloadID, GimbalPointingMode PointingMode, float Azimuth, float Elevation, float Rotation){
    ...
    /**  Current pointing mode of the gimbal to which this payload is attached(Units: None)*/
    public GimballedPayloadState setPointingMode( GimbalPointingMode val ) {
        PointingMode = val;
        return this;
    }
