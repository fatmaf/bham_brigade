...
*/
public class CameraConfiguration extends PayloadConfiguration {
    ...
    @LMCPObject.LmcpType("WavelengthBand")
    protected WavelengthBand SupportedWavelengthBand = WavelengthBand.EO;
    ...
    @LMCPObject.LmcpType("FOVOperationMode")
    protected FOVOperationMode FieldOfViewMode = FOVOperationMode.Continuous;
    ...
    public CameraConfiguration(long PayloadID, String PayloadKind, WavelengthBand SupportedWavelengthBand, FOVOperationMode FieldOfViewMode, float MinHorizontalFieldOfView, float MaxHorizontalFieldOfView, long VideoStreamHorizontalResolution, long VideoStreamVerticalResolution){
    ...
    /**  The supported wavelength band of this camera (Units: None)*/
    public WavelengthBand getSupportedWavelengthBand() { return SupportedWavelengthBand; }

    /**  The supported wavelength band of this camera (Units: None)*/
    public CameraConfiguration setSupportedWavelengthBand( WavelengthBand val ) {
        SupportedWavelengthBand = val;
        return this;
    }

    /**  The manner in which field of views are commanded: Continuous (any FOV between MinHorizontalFieldOfView and MaxHorizontalFieldOfView can be commanded), or Discrete (the only supported FOVs are listed in DiscreteHorizontalFieldOfViewList). (Units: None)*/
    public FOVOperationMode getFieldOfViewMode() { return FieldOfViewMode; }

    /**  The manner in which field of views are commanded: Continuous (any FOV between MinHorizontalFieldOfView and MaxHorizontalFieldOfView can be commanded), or Discrete (the only supported FOVs are listed in DiscreteHorizontalFieldOfViewList). (Units: None)*/
    public CameraConfiguration setFieldOfViewMode( FOVOperationMode val ) {
        FieldOfViewMode = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
        SupportedWavelengthBand = WavelengthBand.unpack( in );

        FieldOfViewMode = FOVOperationMode.unpack( in );
