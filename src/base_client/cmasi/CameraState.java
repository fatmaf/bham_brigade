...
*/
public class CameraState extends GimballedPayloadState {
    ...
    protected java.util.ArrayList<Location3D> Footprint = new java.util.ArrayList<Location3D>();
    ...
    @LMCPObject.LmcpType("Location3D")
    protected Location3D Centerpoint = null;

    
    public CameraState() {
    }

    public CameraState(long PayloadID, GimbalPointingMode PointingMode, float Azimuth, float Elevation, float Rotation, float HorizontalFieldOfView, float VerticalFieldOfView, Location3D Centerpoint){
    ...
    public java.util.ArrayList<Location3D> getFootprint() {
        return Footprint;
    }

    /**  the current location according to the intersection of a ray along the center axis of the current camera field of view with the ground. If this field is null, then the location was not computed. (Units: None)*/
    public Location3D getCenterpoint() { return Centerpoint; }

    /**  the current location according to the intersection of a ray along the center axis of the current camera field of view with the ground. If this field is null, then the location was not computed. (Units: None)*/
    public CameraState setCenterpoint( Location3D val ) {
        Centerpoint = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        Footprint.add( (Location3D) LMCPUtil.getObject(in));
        }
            Centerpoint = (Location3D) LMCPUtil.getObject(in);
