...
*/
public class AutomationResponse extends LMCPObject {
    ...
    protected java.util.ArrayList<MissionCommand> MissionCommandList = new java.util.ArrayList<MissionCommand>();
    /**  A list of VehicleActionCommands issued by the automation service (Units: None)*/
    @LmcpType("VehicleActionCommand")
    protected java.util.ArrayList<VehicleActionCommand> VehicleCommandList = new java.util.ArrayList<VehicleActionCommand>();
    ...
    public java.util.ArrayList<MissionCommand> getMissionCommandList() {
        return MissionCommandList;
    }

    public java.util.ArrayList<VehicleActionCommand> getVehicleCommandList() {
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        MissionCommandList.add( (MissionCommand) LMCPUtil.getObject(in));
        }
        VehicleCommandList.clear();
        int VehicleCommandList_len = LMCPUtil.getUint16(in);
        for(int i=0; i<VehicleCommandList_len; i++){
        VehicleCommandList.add( (VehicleActionCommand) LMCPUtil.getObject(in));
        }
        Info.clear();
