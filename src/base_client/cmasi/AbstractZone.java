...
*/
public class AbstractZone extends LMCPObject {
    ...
    protected AbstractGeometry Boundary = new AbstractGeometry();

    
    public AbstractZone() {
    }

    public AbstractZone(long ZoneID, float MinAltitude, AltitudeType MinAltitudeType, float MaxAltitude, AltitudeType MaxAltitudeType, long StartTime, long EndTime, float Padding, String Label, AbstractGeometry Boundary){
        this.ZoneID = ZoneID;
    ...
    /**  Altitude type for min altitude (Units: None)*/
    public AbstractZone setMinAltitudeType( AltitudeType val ) {
        MinAltitudeType = val;
        return this;
    }
    ...
    /**  Altitude type for max altitude (Units: None)*/
    public AbstractZone setMaxAltitudeType( AltitudeType val ) {
        MaxAltitudeType = val;
        return this;
    }
    ...
    /**  Geometry object describing the boundary. This boundary is 2-dimensional. The zone boundary is defined as an extrusion of this boundary from MinAltitude to MaxAltitude. A valid zone must define a boundary (null not allowed). (Units: None)*/
    public AbstractGeometry getBoundary() { return Boundary; }

    /**  Geometry object describing the boundary. This boundary is 2-dimensional. The zone boundary is defined as an extrusion of this boundary from MinAltitude to MaxAltitude. A valid zone must define a boundary (null not allowed). (Units: None)*/
    public AbstractZone setBoundary( AbstractGeometry val ) {
        Boundary = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        Label = LMCPUtil.getString(in);
            ...
            Boundary = (AbstractGeometry) LMCPUtil.getObject(in);
