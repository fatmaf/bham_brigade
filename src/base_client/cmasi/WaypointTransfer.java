...
*/
public class WaypointTransfer extends LMCPObject {
    ...
    @LmcpType("Waypoint")
    protected java.util.ArrayList<Waypoint> Waypoints = new java.util.ArrayList<Waypoint>();
    /**  describes the transfer action to take (Units: None)*/
    @LmcpType("WaypointTransferMode")
    protected WaypointTransferMode TransferMode = WaypointTransferMode.AddWaypoints;

    
    public WaypointTransfer() {
    }

    public WaypointTransfer(long EntityID, WaypointTransferMode TransferMode){
    ...
    /**  describes the transfer action to take (Units: None)*/
    public WaypointTransferMode getTransferMode() { return TransferMode; }

    /**  describes the transfer action to take (Units: None)*/
    public WaypointTransfer setTransferMode( WaypointTransferMode val ) {
        TransferMode = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        Waypoints.add( (Waypoint) LMCPUtil.getObject(in));
        }
        TransferMode = WaypointTransferMode.unpack( in );
