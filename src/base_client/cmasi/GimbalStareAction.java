...
*/
public class GimbalStareAction extends PayloadAction {
    ...
    @LmcpType("Location3D")
    protected Location3D Starepoint = new Location3D();
    ...
    public GimbalStareAction(long PayloadID, Location3D Starepoint, long Duration){
    ...
    /**  The commanded stare point. A valid GimbalStareAction must define the Starepoint (null not allowed). (Units: None)*/
    public Location3D getStarepoint() { return Starepoint; }

    /**  The commanded stare point. A valid GimbalStareAction must define the Starepoint (null not allowed). (Units: None)*/
    public GimbalStareAction setStarepoint( Location3D val ) {
        Starepoint = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
            Starepoint = (Location3D) LMCPUtil.getObject(in);
