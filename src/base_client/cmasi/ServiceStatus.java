...
*/
public class ServiceStatus extends LMCPObject {
    ...
    *<br/> (Units: None)*/
    ...
    protected ServiceStatusType StatusType = ServiceStatusType.Information;

    
    public ServiceStatus() {
    }

    public ServiceStatus(float PercentComplete, ServiceStatusType StatusType){
    ...
    *<br/> Error. Notes fatal problem(s) 
    *<br/> (Units: None)*/
    public ServiceStatusType getStatusType() { return StatusType; }
    ...
    *<br/> Error. Notes fatal problem(s) 
    *<br/> (Units: None)*/
    public ServiceStatus setStatusType( ServiceStatusType val ) {
        StatusType = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        StatusType = ServiceStatusType.unpack( in );
