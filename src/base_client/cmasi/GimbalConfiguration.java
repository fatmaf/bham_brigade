...
*/
public class GimbalConfiguration extends PayloadConfiguration {
    ...
    protected java.util.ArrayList<GimbalPointingMode> SupportedPointingModes = new java.util.ArrayList<GimbalPointingMode>();
    ...
    public java.util.ArrayList<GimbalPointingMode> getSupportedPointingModes() {
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        SupportedPointingModes.add(GimbalPointingMode.unpack( in ));
