...
*/
public class EntityConfiguration extends LMCPObject {
    ...
    protected AltitudeType NominalAltitudeType = AltitudeType.AGL;
    ...
    protected java.util.ArrayList<PayloadConfiguration> PayloadConfigurationList = new java.util.ArrayList<PayloadConfiguration>();
    ...
    public EntityConfiguration(long ID, String Affiliation, String EntityType, String Label, float NominalSpeed, float NominalAltitude, AltitudeType NominalAltitudeType){
        this.ID = ID;
    ...
    /**  Altitude type for nominal altitude (Units: None)*/
    public AltitudeType getNominalAltitudeType() { return NominalAltitudeType; }

    /**  Altitude type for nominal altitude (Units: None)*/
    public EntityConfiguration setNominalAltitudeType( AltitudeType val ) {
        NominalAltitudeType = val;
        return this;
    }

    public java.util.ArrayList<PayloadConfiguration> getPayloadConfigurationList() {
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        NominalAltitudeType = AltitudeType.unpack( in );
        ...
        PayloadConfigurationList.add( (PayloadConfiguration) LMCPUtil.getObject(in));
        }
        Info.clear();
