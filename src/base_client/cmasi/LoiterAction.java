...
*/
public class LoiterAction extends NavigationAction {
    ...
    @LMCPObject.LmcpType("LoiterType")
    protected base_client.cmasi.LoiterType LoiterType = base_client.cmasi.LoiterType.VehicleDefault;
    ...
    @LMCPObject.LmcpType("LoiterDirection")
    protected LoiterDirection Direction = LoiterDirection.VehicleDefault;
    ...
    @LMCPObject.LmcpType("Location3D")
    protected Location3D Location = new Location3D();

    
    public LoiterAction() {
    }

    public LoiterAction(base_client.cmasi.LoiterType LoiterType, float Radius, float Axis, float Length, LoiterDirection Direction, long Duration, float Airspeed, Location3D Location){
    ...
    /**  The loiter shape that the vehicle should fly (Units: none)*/
    public base_client.cmasi.LoiterType getLoiterType() { return LoiterType; }

    /**  The loiter shape that the vehicle should fly (Units: none)*/
    public LoiterAction setLoiterType( base_client.cmasi.LoiterType val ) {
        LoiterType = val;
        return this;
    }
    ...
    /**  Direction of travel. (Units: None)*/
    public LoiterDirection getDirection() { return Direction; }

    /**  Direction of travel. (Units: None)*/
    public LoiterAction setDirection( LoiterDirection val ) {
        Direction = val;
        return this;
    }
    ...
    /**  The geometric center point of the loiter. A valid LoiterAction must define Location (null not allowed). (Units: None)*/
    public Location3D getLocation() { return Location; }

    /**  The geometric center point of the loiter. A valid LoiterAction must define Location (null not allowed). (Units: None)*/
    public LoiterAction setLocation( Location3D val ) {
        Location = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
        LoiterType = base_client.cmasi.LoiterType.unpack( in );
        ...
        Direction = LoiterDirection.unpack( in );

        Duration = LMCPUtil.getInt64(in);

        Airspeed = LMCPUtil.getReal32(in);

            Location = (Location3D) LMCPUtil.getObject(in);
