...
*/
public class WeatherReport extends LMCPObject {
    ...
    protected AbstractZone Area = null;
    ...
    public WeatherReport(AbstractZone Area, float WindSpeed, float WindDirection, float Visibility, float CloudCeiling, float CloudCoverage){
        this.Area = Area;
    ...
    /**  The area for which this report pertains. If this is null, then the report pertains to the entire mission area. (Units: None)*/
    public AbstractZone getArea() { return Area; }

    /**  The area for which this report pertains. If this is null, then the report pertains to the entire mission area. (Units: None)*/
    public WeatherReport setArea( AbstractZone val ) {
        Area = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
            Area = (AbstractZone) LMCPUtil.getObject(in);
