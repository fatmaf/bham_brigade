...
*/
public class GimbalState extends PayloadState {
    ...
    @LMCPObject.LmcpType("GimbalPointingMode")
    protected GimbalPointingMode PointingMode = GimbalPointingMode.Unknown;
    ...
    public GimbalState(long PayloadID, GimbalPointingMode PointingMode, float Azimuth, float Elevation, float Rotation){
    ...
    /**  Current pointing mode of the gimbal (Units: None)*/
    public GimbalPointingMode getPointingMode() { return PointingMode; }

    /**  Current pointing mode of the gimbal (Units: None)*/
    public GimbalState setPointingMode( GimbalPointingMode val ) {
        PointingMode = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
        PointingMode = GimbalPointingMode.unpack( in );
