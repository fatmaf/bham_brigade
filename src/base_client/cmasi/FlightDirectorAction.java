...
*/
public class FlightDirectorAction extends NavigationAction {
    ...
    protected base_client.cmasi.AltitudeType AltitudeType = base_client.cmasi.AltitudeType.MSL;
    ...
    public FlightDirectorAction(float Speed, base_client.cmasi.SpeedType SpeedType, float Heading, float Altitude, base_client.cmasi.AltitudeType AltitudeType, float ClimbRate){
        this.Speed = Speed;
    ...
    /**  type of speed to fly (Units: None)*/
    public FlightDirectorAction setSpeedType( base_client.cmasi.SpeedType val ) {
        SpeedType = val;
        return this;
    }
    ...
    /**  Altitude type for specified altitude (Units: None)*/
    public base_client.cmasi.AltitudeType getAltitudeType() { return AltitudeType; }

    /**  Altitude type for specified altitude (Units: None)*/
    public FlightDirectorAction setAltitudeType( base_client.cmasi.AltitudeType val ) {
        AltitudeType = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        AltitudeType = base_client.cmasi.AltitudeType.unpack( in );
