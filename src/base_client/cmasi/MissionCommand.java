...
*/
public class MissionCommand extends VehicleActionCommand {
    ...
    @LMCPObject.LmcpType("Waypoint")
    protected java.util.ArrayList<Waypoint> WaypointList = new java.util.ArrayList<Waypoint>();
    ...
    public MissionCommand(long CommandID, long VehicleID, CommandStatusType Status, long FirstWaypoint){
    ...
    public java.util.ArrayList<Waypoint> getWaypointList() {
        return WaypointList;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        WaypointList.add( (Waypoint) LMCPUtil.getObject(in));
        }
