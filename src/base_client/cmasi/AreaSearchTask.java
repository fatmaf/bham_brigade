...
/**
 Area search task 
*/
public class AreaSearchTask extends SearchTask {
    ...
    protected AbstractGeometry SearchArea = new AbstractGeometry();
    ...
    public AreaSearchTask(long TaskID, String Label, float RevisitRate, short Priority, boolean Required, long DwellTime, float GroundSampleDistance, AbstractGeometry SearchArea){
        this.TaskID = TaskID;
        this.Label = Label;
    ...
    /**  Area to search. A valid area search task must define a SearchArea (null not allowed) (Units: None)*/
    public AbstractGeometry getSearchArea() { return SearchArea; }

    /**  Area to search. A valid area search task must define a SearchArea (null not allowed) (Units: None)*/
    public AreaSearchTask setSearchArea( AbstractGeometry val ) {
        SearchArea = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
            SearchArea = (AbstractGeometry) LMCPUtil.getObject(in);
        ViewAngleList.clear();
