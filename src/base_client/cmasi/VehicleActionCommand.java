...
*/
public class VehicleActionCommand extends LMCPObject {
    ...
    protected CommandStatusType Status = CommandStatusType.Pending;

    
    public VehicleActionCommand() {
    }

    public VehicleActionCommand(long CommandID, long VehicleID, CommandStatusType Status){
    ...
    /**  Denotes the current execution status of this command. (Units: None)*/
    public CommandStatusType getStatus() { return Status; }

    /**  Denotes the current execution status of this command. (Units: None)*/
    public VehicleActionCommand setStatus( CommandStatusType val ) {
        Status = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        Status = CommandStatusType.unpack( in );
