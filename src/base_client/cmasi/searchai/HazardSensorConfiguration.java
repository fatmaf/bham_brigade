...
import base_client.cmasi.PayloadConfiguration;
...
*/
public class HazardSensorConfiguration extends PayloadConfiguration {
    ...
    protected java.util.ArrayList<HazardType> DetectableHazardTypes = new java.util.ArrayList<HazardType>();
    ...
    public java.util.ArrayList<HazardType> getDetectableHazardTypes() {
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        DetectableHazardTypes.add(HazardType.unpack( in ));
