...
*/
public class RecoveryPoint extends Location3D {
    ...
    public RecoveryPoint(double Latitude, double Longitude, float Altitude, base_client.cmasi.AltitudeType AltitudeType, String LocationName){
