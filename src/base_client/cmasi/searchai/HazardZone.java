...
import base_client.cmasi.AbstractZone;
import base_client.cmasi.AltitudeType;
import base_client.avtas.lmcp.LMCPObject;

/**
 Representation of a hazard in the scenario.  This defines a 3D zone based on              a 2D geometry and min/max altitude. See { CMASI/AbstractZone} for              details regarding CMASI zone definition.
*/
public class HazardZone extends AbstractZone {
    ...
    /** (Units: None)*/
    @LMCPObject.LmcpType("HazardType")
    protected HazardType ZoneType = HazardType.Undefined;

    
    public HazardZone() {
    }

    public HazardZone(long ZoneID, float MinAltitude, AltitudeType MinAltitudeType, float MaxAltitude, AltitudeType MaxAltitudeType, long StartTime, long EndTime, float Padding, String Label, AbstractGeometry Boundary, HazardType ZoneType){
        this.ZoneID = ZoneID;
    ...
    /** (Units: None)*/
    public HazardType getZoneType() { return ZoneType; }

    /** (Units: None)*/
    public HazardZone setZoneType( HazardType val ) {
        ZoneType = val;
        return this;
    }
