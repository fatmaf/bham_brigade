...
import base_client.cmasi.AbstractGeometry;
...
*/
public class HazardZoneEstimateReport extends LMCPObject {
    ...
    protected AbstractGeometry EstimatedZoneShape = new AbstractGeometry();
    ...
    @LmcpType("HazardType")
    protected HazardType PerceivedZoneType = HazardType.Undefined;
    ...
    public HazardZoneEstimateReport(long UniqueTrackingID, AbstractGeometry EstimatedZoneShape, float EstimatedGrowthRate, HazardType PerceivedZoneType, float EstimatedZoneDirection, float EstimatedZoneSpeed){
    ...
    /**  Estimated shape of the zone. Can be null. If null, then the service is reporting that is is not estimating the shape of the zone. (Units: None)*/
    public AbstractGeometry getEstimatedZoneShape() { return EstimatedZoneShape; }

    /**  Estimated shape of the zone. Can be null. If null, then the service is reporting that is is not estimating the shape of the zone. (Units: None)*/
    public HazardZoneEstimateReport setEstimatedZoneShape( AbstractGeometry val ) {
    ...
    /**  Type of perceived zone being reported (Units: None)*/
    public HazardType getPerceivedZoneType() { return PerceivedZoneType; }

    /**  Type of perceived zone being reported (Units: None)*/
    public HazardZoneEstimateReport setPerceivedZoneType( HazardType val ) {
    ...
    public void unpack(InputStream in) throws IOException {
        UniqueTrackingID = LMCPUtil.getUint32(in);
            ...
            EstimatedZoneShape = (AbstractGeometry) LMCPUtil.getObject(in);
        EstimatedGrowthRate = LMCPUtil.getReal32(in);

        PerceivedZoneType = HazardType.unpack( in );
