...
*/
public class EntityState extends LMCPObject {
    ...
    protected java.util.ArrayList<PayloadState> PayloadStateList = new java.util.ArrayList<PayloadState>();
    ...
    protected NavigationMode Mode = NavigationMode.Waypoint;
    ...
    protected java.util.ArrayList<KeyValuePair> Info = new java.util.ArrayList<KeyValuePair>();

    
    public EntityState() {
    }

    public EntityState(long ID, float u, float v, float w, float udot, float vdot, float wdot, float Heading, float Pitch, float Roll, float p, float q, float r, float Course, float Groundspeed, Location3D Location, float EnergyAvailable, float ActualEnergyRate, long CurrentWaypoint, long CurrentCommand, NavigationMode Mode, long Time){
        this.ID = ID;
        this.u = u;
        this.v = v;
        this.w = w;
    ...
    /**  The perceived entity location. A valid EntityState must include Location (null not allowed) (Units: None)*/
    public EntityState setLocation( Location3D val ) {
        Location = val;
        return this;
    }
    ...
    public java.util.ArrayList<PayloadState> getPayloadStateList() {
    ...
    /**  The current mode for this vehicle. (Units: None)*/
    public EntityState setMode( NavigationMode val ) {
        Mode = val;
        return this;
    }
    ...
    public java.util.ArrayList<KeyValuePair> getInfo() {
        return Info;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        PayloadStateList.add( (PayloadState) LMCPUtil.getObject(in));
        }
        CurrentWaypoint = LMCPUtil.getInt64(in);

        CurrentCommand = LMCPUtil.getInt64(in);

        Mode = NavigationMode.unpack( in );
        ...
        Info.add( (KeyValuePair) LMCPUtil.getObject(in));
        }
