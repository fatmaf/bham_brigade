...
*/
public class OperatorSignal extends LMCPObject {
    ...
    protected java.util.ArrayList<KeyValuePair> Signals = new java.util.ArrayList<KeyValuePair>();
    ...
    public java.util.ArrayList<KeyValuePair> getSignals() {
        return Signals;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        Signals.add( (KeyValuePair) LMCPUtil.getObject(in));
        }
