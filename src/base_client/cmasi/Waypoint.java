...
*/
public class Waypoint extends Location3D {
    ...
    @LMCPObject.LmcpType("real32")
    protected float Speed = (float)0;
    /**  Type of commanded speed (Units: None)*/
    @LMCPObject.LmcpType("SpeedType")
    protected base_client.cmasi.SpeedType SpeedType = base_client.cmasi.SpeedType.Airspeed;
    ...
    @LMCPObject.LmcpType("TurnType")
    protected base_client.cmasi.TurnType TurnType = base_client.cmasi.TurnType.TurnShort;
    /**  A list of actions to perform at this waypoint (Units: None)*/
    @LMCPObject.LmcpType("VehicleAction")
    protected java.util.ArrayList<VehicleAction> VehicleActionList = new java.util.ArrayList<VehicleAction>();
    ...
    public Waypoint(double Latitude, double Longitude, float Altitude, base_client.cmasi.AltitudeType AltitudeType, long Number, long NextWaypoint, float Speed, base_client.cmasi.SpeedType SpeedType, float ClimbRate, base_client.cmasi.TurnType TurnType, long ContingencyWaypointA, long ContingencyWaypointB){
    ...
    /**  Type of commanded speed (Units: None)*/
    public base_client.cmasi.SpeedType getSpeedType() { return SpeedType; }

    /**  Type of commanded speed (Units: None)*/
    public Waypoint setSpeedType( base_client.cmasi.SpeedType val ) {
        SpeedType = val;
        return this;
    }
    ...
    /**  The type of turn to execute (Units: None)*/
    public base_client.cmasi.TurnType getTurnType() { return TurnType; }

    /**  The type of turn to execute (Units: None)*/
    public Waypoint setTurnType( base_client.cmasi.TurnType val ) {
        TurnType = val;
        return this;
    }

    public java.util.ArrayList<VehicleAction> getVehicleActionList() {
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        SpeedType = base_client.cmasi.SpeedType.unpack( in );

        ClimbRate = LMCPUtil.getReal32(in);

        TurnType = base_client.cmasi.TurnType.unpack( in );

        VehicleActionList.clear();
        int VehicleActionList_len = LMCPUtil.getUint16(in);
        for(int i=0; i<VehicleActionList_len; i++){
        VehicleActionList.add( (VehicleAction) LMCPUtil.getObject(in));
        }
