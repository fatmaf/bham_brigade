...
*/
public class SessionStatus extends LMCPObject {
    ...
    protected SimulationStatusType State = SimulationStatusType.Stopped;
    ...
    protected java.util.ArrayList<KeyValuePair> Parameters = new java.util.ArrayList<KeyValuePair>();

    
    public SessionStatus() {
    }

    public SessionStatus(SimulationStatusType State, long StartTime, long ScenarioTime, float RealTimeMultiple){
        this.State = State;
    ...
    /**  The current state of the session (Units: None)*/
    public SimulationStatusType getState() { return State; }

    /**  The current state of the session (Units: None)*/
    public SessionStatus setState( SimulationStatusType val ) {
        State = val;
        return this;
    }
    ...
    public java.util.ArrayList<KeyValuePair> getParameters() {
        return Parameters;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        State = SimulationStatusType.unpack( in );
        ...
        Parameters.add( (KeyValuePair) LMCPUtil.getObject(in));
        }
