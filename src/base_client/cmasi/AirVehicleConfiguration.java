...
*/
public class AirVehicleConfiguration extends EntityConfiguration {
    ...
    protected FlightProfile NominalFlightProfile = new FlightProfile();
    ...
    @LmcpType("FlightProfile")
    protected java.util.ArrayList<FlightProfile> AlternateFlightProfiles = new java.util.ArrayList<FlightProfile>();
    /**  A list of available loiter types for this aircraft (Units: None)*/
    @LmcpType("LoiterType")
    protected java.util.ArrayList<LoiterType> AvailableLoiterTypes = new java.util.ArrayList<LoiterType>();
    /**  A list of available turning modes for this aircraft (Units: None)*/
    @LmcpType("TurnType")
    protected java.util.ArrayList<TurnType> AvailableTurnTypes = new java.util.ArrayList<TurnType>();
    ...
    protected AltitudeType MinAltitudeType = AltitudeType.AGL;
    ...
    @LmcpType("AltitudeType")
    protected AltitudeType MaxAltitudeType = AltitudeType.MSL;

    
    public AirVehicleConfiguration() {
    }

    public AirVehicleConfiguration(long ID, String Affiliation, String EntityType, String Label, float NominalSpeed, float NominalAltitude, AltitudeType NominalAltitudeType, float MinimumSpeed, float MaximumSpeed, FlightProfile NominalFlightProfile, float MinimumAltitude, AltitudeType MinAltitudeType, float MaximumAltitude, AltitudeType MaxAltitudeType){
        this.ID = ID;
    ...
    /**  Describes the preferred operating mode for most planning purposes. This can be a max range or endurance speed profile, or any other operating point chosen by a user. This field may not be null. (Units: None)*/
    public FlightProfile getNominalFlightProfile() { return NominalFlightProfile; }

    /**  Describes the preferred operating mode for most planning purposes. This can be a max range or endurance speed profile, or any other operating point chosen by a user. This field may not be null. (Units: None)*/
    public AirVehicleConfiguration setNominalFlightProfile( FlightProfile val ) {
        NominalFlightProfile = val;
        return this;
    }

    public java.util.ArrayList<FlightProfile> getAlternateFlightProfiles() {
        return AlternateFlightProfiles;
    }

    public java.util.ArrayList<LoiterType> getAvailableLoiterTypes() {
        return AvailableLoiterTypes;
    }

    public java.util.ArrayList<TurnType> getAvailableTurnTypes() {
    ...
    /**  Altitude type for min altitude (Units: None)*/
    public AltitudeType getMinAltitudeType() { return MinAltitudeType; }

    /**  Altitude type for min altitude (Units: None)*/
    public AirVehicleConfiguration setMinAltitudeType( AltitudeType val ) {
        MinAltitudeType = val;
        return this;
    }
    ...
    /**  Altitude type for max altitude (Units: None)*/
    public AltitudeType getMaxAltitudeType() { return MaxAltitudeType; }

    /**  Altitude type for max altitude (Units: None)*/
    public AirVehicleConfiguration setMaxAltitudeType( AltitudeType val ) {
        MaxAltitudeType = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        MaximumSpeed = LMCPUtil.getReal32(in);
            ...
            NominalFlightProfile = (FlightProfile) LMCPUtil.getObject(in);
