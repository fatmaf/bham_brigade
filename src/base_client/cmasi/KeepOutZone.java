...
*/
public class KeepOutZone extends AbstractZone {
    ...
    *<br/> Threat Defines an area where a threat is present. (Units: None)*/
    @LMCPObject.LmcpType("ZoneAvoidanceType")
    protected ZoneAvoidanceType ZoneType = ZoneAvoidanceType.Physical;

    
    public KeepOutZone() {
    }

    public KeepOutZone(long ZoneID, float MinAltitude, AltitudeType MinAltitudeType, float MaxAltitude, AltitudeType MaxAltitudeType, long StartTime, long EndTime, float Padding, String Label, AbstractGeometry Boundary, ZoneAvoidanceType ZoneType){
        this.ZoneID = ZoneID;
    ...
    *<br/> Acoustic Defines an area for acoustical avoidance 
    *<br/> Threat Defines an area where a threat is present. (Units: None)*/
    public ZoneAvoidanceType getZoneType() { return ZoneType; }
    ...
    *<br/> Acoustic Defines an area for acoustical avoidance 
    *<br/> Threat Defines an area where a threat is present. (Units: None)*/
    public KeepOutZone setZoneType( ZoneAvoidanceType val ) {
        ZoneType = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
        ZoneType = ZoneAvoidanceType.unpack( in );
