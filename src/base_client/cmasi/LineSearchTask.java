...
*/
public class LineSearchTask extends SearchTask {
    ...
    @LmcpType("Location3D")
    protected java.util.ArrayList<Location3D> PointList = new java.util.ArrayList<Location3D>();
    ...
    public java.util.ArrayList<Location3D> getPointList() {
        return PointList;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        PointList.add( (Location3D) LMCPUtil.getObject(in));
        }
        ViewAngleList.clear();
