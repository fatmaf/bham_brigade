...
/**
 Point search task 
*/
public class PointSearchTask extends SearchTask {
    ...
    @LmcpType("Location3D")
    protected Location3D SearchLocation = new Location3D();
    ...
    @LmcpType("Wedge")
    protected java.util.ArrayList<Wedge> ViewAngleList = new java.util.ArrayList<Wedge>();

    
    public PointSearchTask() {
    }

    public PointSearchTask(long TaskID, String Label, float RevisitRate, short Priority, boolean Required, long DwellTime, float GroundSampleDistance, Location3D SearchLocation, float StandoffDistance){
        this.TaskID = TaskID;
        this.Label = Label;
    ...
    /**  Point to search. A valid PointSearchTask must define SearchLocation (null not allowed). (Units: None)*/
    public Location3D getSearchLocation() { return SearchLocation; }

    /**  Point to search. A valid PointSearchTask must define SearchLocation (null not allowed). (Units: None)*/
    public PointSearchTask setSearchLocation( Location3D val ) {
        SearchLocation = val;
        return this;
    }
    ...
    public java.util.ArrayList<Wedge> getViewAngleList() {
