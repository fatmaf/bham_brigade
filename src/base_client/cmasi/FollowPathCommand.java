...
*/
public class FollowPathCommand extends VehicleActionCommand {
    ...
    @LMCPObject.LmcpType("PathWaypoint")
    protected java.util.ArrayList<PathWaypoint> WaypointList = new java.util.ArrayList<PathWaypoint>();
    ...
    @LMCPObject.LmcpType("TravelMode")
    protected TravelMode RepeatMode = TravelMode.SinglePass;

    
    public FollowPathCommand() {
    }

    public FollowPathCommand(long CommandID, long VehicleID, CommandStatusType Status, long FirstWaypoint, long StartTime, long StopTime, TravelMode RepeatMode){
    ...
    public java.util.ArrayList<PathWaypoint> getWaypointList() {
        return WaypointList;
    }
    ...
    /**  Describes how the entity should treat the end-of-path. Entities can complete the path once, or continuously.(Units: None)*/
    public TravelMode getRepeatMode() { return RepeatMode; }

    /**  Describes how the entity should treat the end-of-path. Entities can complete the path once, or continuously.(Units: None)*/
    public FollowPathCommand setRepeatMode( TravelMode val ) {
        RepeatMode = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        WaypointList.add( (PathWaypoint) LMCPUtil.getObject(in));
        }
        StartTime = LMCPUtil.getInt64(in);

        StopTime = LMCPUtil.getInt64(in);

        RepeatMode = TravelMode.unpack( in );
