...
*/
public class EntityPerception extends LMCPObject {
    ...
    public EntityPerception(long PerceivedEntityID, long PerceiverID, boolean VelocityValid, boolean AttitudeValid, Location3D Location, long TimeLastSeen){
    ...
    /**  The entity location. A valid EntityPerception must define Location (null not allowed) (Units: None)*/
    public EntityPerception setLocation( Location3D val ) {
        Location = val;
        return this;
    }
