...
package base_client.cmasi.perceive;
...
*/
public class TrackEntityTask extends Task {
    ...
    protected WavelengthBand SensorModality = WavelengthBand.AllAny;
    ...
    public TrackEntityTask(long TaskID, String Label, float RevisitRate, short Priority, boolean Required, long EntityID, WavelengthBand SensorModality, float GroundSampleDistance){
        this.TaskID = TaskID;
        this.Label = Label;
    ...
    /**  Required sensor modality for tracking the target (Units: None)*/
    public WavelengthBand getSensorModality() { return SensorModality; }

    /**  Required sensor modality for tracking the target (Units: None)*/
    public TrackEntityTask setSensorModality( WavelengthBand val ) {
        SensorModality = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        SensorModality = WavelengthBand.unpack( in );
