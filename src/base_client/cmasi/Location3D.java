...
*/
public class Location3D extends LMCPObject {
    ...
    public Location3D(double Latitude, double Longitude, float Altitude, base_client.cmasi.AltitudeType AltitudeType){
    ...
    /**  Altitude type for specified altitude (Units: None)*/
    public Location3D setAltitudeType( base_client.cmasi.AltitudeType val ) {
        AltitudeType = val;
        return this;
    }
