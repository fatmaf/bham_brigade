...
public class Rectangle extends AbstractGeometry {
    ...
    protected Location3D CenterPoint = new Location3D();
    ...
    public Rectangle(Location3D CenterPoint, float Width, float Height, float Rotation){
    ...
    /**  Center point of the rectangle (note altitude value is ignored). A valid Rectangle must define CenterPoint (null not allowed). (Units: None)*/
    public Rectangle setCenterPoint( Location3D val ) {
        CenterPoint = val;
        return this;
    }
