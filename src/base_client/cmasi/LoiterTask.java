...
*/
public class LoiterTask extends Task {
    ...
    protected LoiterAction DesiredAction = new LoiterAction();

    
    public LoiterTask() {
    }

    public LoiterTask(long TaskID, String Label, float RevisitRate, short Priority, boolean Required, LoiterAction DesiredAction){
        this.TaskID = TaskID;
        this.Label = Label;
    ...
    /**  The desired loiter action to take. Must not be null. (Units: none)*/
    public LoiterAction getDesiredAction() { return DesiredAction; }

    /**  The desired loiter action to take. Must not be null. (Units: none)*/
    public LoiterTask setDesiredAction( LoiterAction val ) {
        DesiredAction = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
            DesiredAction = (LoiterAction) LMCPUtil.getObject(in);
