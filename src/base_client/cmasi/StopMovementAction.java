...
*/
public class StopMovementAction extends VehicleAction {
    ...
    @LmcpType("Location3D")
    protected Location3D Location = null;

    
    public StopMovementAction() {
    }

    public StopMovementAction(Location3D Location){
    ...
    /**  A location at which the entity should stop. If this is null, the entity will stop immediately. (Units: None)*/
    public StopMovementAction setLocation( Location3D val ) {
        Location = val;
        return this;
    }
