...
*/
public class MustFlyTask extends Task {
    ...
    @LmcpType("Location3D")
    protected Location3D Position = new Location3D();
    ...
    public MustFlyTask(long TaskID, String Label, float RevisitRate, short Priority, boolean Required, Location3D Position, boolean UseAltitude){
        this.TaskID = TaskID;
        this.Label = Label;
    ...
    /**  Point that vehicle must fly through. Null position not allowed. (Units: None)*/
    public Location3D getPosition() { return Position; }

    /**  Point that vehicle must fly through. Null position not allowed. (Units: None)*/
    public MustFlyTask setPosition( Location3D val ) {
        Position = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
            Position = (Location3D) LMCPUtil.getObject(in);
