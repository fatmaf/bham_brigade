...
public class Polygon extends AbstractGeometry {
    ...
    protected java.util.ArrayList<Location3D> BoundaryPoints = new java.util.ArrayList<Location3D>();
    ...
    public java.util.ArrayList<Location3D> getBoundaryPoints() {
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        BoundaryPoints.add( (Location3D) LMCPUtil.getObject(in));
        }
