...
public class SearchTask extends Task {
    ...
    protected java.util.ArrayList<WavelengthBand> DesiredWavelengthBands = new java.util.ArrayList<WavelengthBand>();
    ...
    public java.util.ArrayList<WavelengthBand> getDesiredWavelengthBands() {
    ...
    public void unpack(InputStream in) throws IOException {
        ...
        DesiredWavelengthBands.add(WavelengthBand.unpack( in ));
