 ...
 */
public class Scenario0Client extends Thread {
	...
	public Socket connect(String host, int port) {
		...
		try {
			...
			try {
				...
				Logger.getLogger(Scenario0Client.class.getName()).log(Level.SEVERE, null, ex1);
			}
...
//        System.out.println(xmlVersion);
	...
	public void run() {
		try {
			...
			Logger.getLogger(Scenario0Client.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
